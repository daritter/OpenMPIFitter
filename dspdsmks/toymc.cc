...
int main(int argc, char* argv[]){
    ...
    desc.add_options()
        ...
        ("toymc-input", po::value<std::vector<std::string> >(&pdf.getFiles())->composing(),
        ...
        ("parameter-in,i", po::value<std::string>(&toymc.parameterIn)->default_value(toymc.parameterIn),
